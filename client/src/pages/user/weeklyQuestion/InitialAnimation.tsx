...
const InitialAnimation = () => {
  return (
    <Stack width={"100%"} height={"100%"} alignItems={"center"} justifyContent={"center"} bgcolor={"#242424b6"} sx={{backdropFilter:"blur(4px)"}}>
      ...
      <motion.div initial={{opacity:0,y:50}} animate={{opacity:1,y:0}} transition={{duration:0.3,delay:2}}><Typography fontSize={"3rem"} marginTop={"75px"} fontWeight={"900"} textAlign={"center"}>Weekly Sangram</Typography></motion.div>
    </Stack>
  )
}
